...
def single_avalanche_plot(param_string, characterizing_text, fit):
    ...
    if fit == 'sf':
        try:
            ...
            parameters_scale_free, covariance_scale_free = curve_fit(scale_free, sizes[3:25], percentages[3:25], p0=[-3, 5000], bounds=([-np.inf, 0], [0, np.inf])) #[0:75] for [32x32], g=0.001; [1:50] for [32x32], g=0.01; [5:200] for [64x64], g=0.01; [5:100] for [64x64, g=0.001, 0.003]; [20:200] for [96x96], g=0.01
